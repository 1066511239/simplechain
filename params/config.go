...
var (
	...
	//
	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), big.NewInt(0), nil, nil, nil, new(ScryptConfig)}
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v  Constantinople: %v  ConstantinopleFix: %v Engine: %v}",
		c.ChainID,
		//c.HomesteadBlock,
		//c.DAOForkBlock,
		//c.DAOForkSupport,
