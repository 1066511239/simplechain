...
func main() {
	...
	// Create an SimpleChain network based off of the Ropsten config
...
func makeGenesis(faucets []*ecdsa.PrivateKey) *core.Genesis {
	...
	genesis.Difficulty = big.NewInt(10240)
...
func makeMiner(genesis *core.Genesis) (*node.Node, error) {
	// Define the basic configurations for the SimpleChain node
	...
	// Start the node and configure a full SimpleChain node on it
