...
import (
	...
	"github.com/simplechain-org/simplechain/contracts/chequebook"
	"github.com/simplechain-org/simplechain/contracts/ens"
	...
	"github.com/simplechain-org/simplechain/p2p/protocols"
	...
	httpapi "github.com/simplechain-org/simplechain/swarm/api/http"
	"github.com/simplechain-org/simplechain/swarm/fuse"
	"github.com/simplechain-org/simplechain/swarm/log"
	"github.com/simplechain-org/simplechain/swarm/network"
	"github.com/simplechain-org/simplechain/swarm/network/stream"
	"github.com/simplechain-org/simplechain/swarm/pss"
	...
	"github.com/simplechain-org/simplechain/swarm/swap"
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	switch {
	case version == "1" && block.Hash() == params.SipeMainnetGenesisHash:
		log.Info("using simplechain Mainnet ENS contract address", "addr", ens.MainNetAddress)
		return ens.MainNetAddress, nil

	case version == "3" && block.Hash() == params.SipeTestnetGenesisHash:
		log.Info("using simplechain Testnet ENS contract address", "addr", ens.TestNetAddress)
