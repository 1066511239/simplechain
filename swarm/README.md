...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/simplechain-org/simplechain

    go install github.com/simplechain-org/simplechain/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/simplechain-org/simplechain`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/simplechain-org/simplechain
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/simplechain-org/simplechain/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/simplechain-org/simplechain/wiki/Code-Review-Guidelines).
