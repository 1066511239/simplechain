...
import (
	...
	"github.com/simplechain-org/simplechain/internal/build"
	"github.com/simplechain-org/simplechain/params"
	sv "github.com/simplechain-org/simplechain/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/simplechain-org/simplechain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/simplechain-org/simplechain/mobile")
