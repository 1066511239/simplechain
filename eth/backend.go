...
import (
	...
	"github.com/simplechain-org/simplechain/consensus/clique"
	...
	"github.com/simplechain-org/simplechain/core/bloombits"
	...
	"github.com/simplechain-org/simplechain/eth/filters"
	"github.com/simplechain-org/simplechain/eth/gasprice"
	...
	"github.com/simplechain-org/simplechain/miner"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	log.Info("Initialising SimpleChain network base on Ethereum protocol", "versions", ProtocolVersions, "network", config.NetworkId)

	if !config.SkipBcVersionCheck {
		bcVersion := rawdb.ReadDatabaseVersion(chainDb)
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, Sipe %s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
