...
//
// https://github.com/simplechain-org/simplechain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/simplechain-org/simplechain/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicTransactionPoolAPI) SendRawTransaction(ctx context.Context, encodedTx hexutil.Bytes) (common.Hash, error) {
	...
	if err := tx.DecodeHashTx(encodedTx); err != nil {
		return common.Hash{}, err
	}
