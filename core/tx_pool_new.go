...
func (pool *TxPool) Pending() types.Transactions {
	...
	pending := make(types.Transactions, 0, pool.queue.Len())
	pool.queue.Loop(func(transaction *types.Transaction) bool {
...
func (pool *TxPool) validateTx(tx *types.Transaction /*, local bool*/) error {
	...
	if !pool.nonceCheck.IsNonceOk(tx) {
